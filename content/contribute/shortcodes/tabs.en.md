...
If you just want a single tab you can instead call the [`tab` shortcode]({{% relref "contribute/shortcodes/tab" %}}) standalone.
...
See the [`tab` shortcode]({{% relref "contribute/shortcodes/tab" %}}) for a description of the parameter for nested tabs.
...
| **style**             | _&lt;empty&gt;_  | Sets a default value for every contained tab. Can be overridden by each tab. See the [`tab` shortcode]({{% relref "contribute/shortcodes/tab#parameter" %}}) for possible values.                                                                                                                                                                            |
| **color**             | _&lt;empty&gt;_  | Sets a default value for every contained tab. Can be overridden by each tab. See the [`tab` shortcode]({{% relref "contribute/shortcodes/tab#parameter" %}}) for possible values.                                                                                                                                                                            |
| **title**             | _&lt;empty&gt;_  | Arbitrary title written in front of the tab view.                                                                                                                                                                                                                                                                                                            |
| **icon**              | _&lt;empty&gt;_  | [Font Awesome icon name]({{%relref "contribute/shortcodes/icon#finding-an-icon" %}}) set to the left of the title.                                                                                                                                                                                                                                           |
...
You can also set style and color parameter for all tabs and overwrite them on tab level. See the [`tab` shortcode]({{% relref "contribute/shortcodes/tab#parameter" %}}) for possible values.
